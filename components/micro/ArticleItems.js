  ...
  function ArticleItems({ article, index }) {
    ...
    return (
      <div key={index} className="flex md:contents">
        <div className="col-start-4 col-end-12 my-4 mr-auto w-full rounded-md dark:bg-slate-800 dark:text-white p-4 shadow-md duration-500 ease-in-out hover:scale-102 hover:cursor-default hover:shadow-xl">
            <span className="lg:float-right rounded bg-yellow-700 px-2 py-1 text-xs font-bold leading-none text-white">
